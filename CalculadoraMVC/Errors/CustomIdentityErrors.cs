namespace CalculadoraMVC.Errors
{
   ...
   public class CustomIdentityErrorDescriber : IdentityErrorDescriber
   {
      ...
      {
         return new IdentityError { Code = nameof(PasswordRequiresNonAlphanumeric), Description = "La contraseña deben tener al menos un dígito ('0'-'9')" };
      }
